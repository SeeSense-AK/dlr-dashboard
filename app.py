...
# ────────────────────────────────────────────────
st.set_page_config(
    page_title="Dún Laoghaire–Rathdown Safety Dashboard",
    page_icon="🚴‍♂️",
    layout="wide",
...
def create_professional_header():
    ...
    <div class="dashboard-header">
        <div class="header-title">Dún Laoghaire–Rathdown Safety Dashboard</div>
        <div class="header-subtitle">AI-Powered Road Safety Analysis by See.Sense</div>
    </div>
